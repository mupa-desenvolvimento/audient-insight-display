...
const formSchema = z.object({
  ...
  auth_method: z.enum(["GET", "POST"]).default("POST"),
  ...
  useEffect(() => {
    if (integration) {
      form.reset({
        ...
        auth_method: (String(integration.auth_method || "POST").toUpperCase() as any) === "GET" ? "GET" : "POST",
        ...
        request_method: (String(integration.request_method || "GET").toUpperCase() as any) === "POST" ? "POST" : "GET",
