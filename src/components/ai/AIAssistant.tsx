  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Olá! Sou o assistente virtual da MUPA. Posso ajudar você a gerenciar playlists, consultar dispositivos, mídias ou estatísticas do sistema. Como posso ajudar hoje?",
      timestamp: new Date(),
    },
  ]);
    ...
    try {
      ...
      if (data.action_taken) {
        toast({
          ...
          description: data.action_description || "Solicitação processada.",
        });
      }
    } catch (err) {
